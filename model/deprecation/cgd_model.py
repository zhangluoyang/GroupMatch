...
from model.deprecation.resnet_layer import resnet50, resnext50_32x4d
...
class Model(nn.Module):
    def __init__(self, backbone_type: str, gd_config: str, feature_dim: int, num_classes: int):
        """

        :param backbone_type: 特征提取器类型
        :param gd_config: 特征的模式选择
        :param feature_dim: 抽取的特征维度
        :param num_classes:
        """
        super().__init__()
